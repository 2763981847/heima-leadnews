...
public class GreenImageScan {
    ...
    public Map<String, String> imageScan(List<byte[]> imageList) throws Exception {
        ...
        List<String> urlList = imageList.stream()
                .map(clientUploader::uploadBytes).collect(Collectors.toList());
        return imageScanByUrls(urlList);
    }

    public Map<String, String> imageScanByUrls(List<String> imageList) throws Exception {
        /**
